...
<script>
	$(document).ready(function(){
		...
		$("#add").click(function(e){
			e.preventDefault();
			i++;
			$("#mytable").append('<tr id="row'+i+'"><td>Name : <input type="text" name="name[]" id="name" class="form-control name_list"></td><td><br><button name="remove" id="'+i+'" class="btn btn-success btn_remove">X</button></td></tr>');
		});
